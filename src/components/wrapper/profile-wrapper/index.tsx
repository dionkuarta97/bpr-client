...
const ProfileWrapper = () => {
  ...
  return (
    <div className="flex flex-row w-full border-2 rounded-lg border-border-primary bg-white h-screen">
      <div className="flex p-4 flex-col border-r border-border-secondary w-1/5">
      ...
      <div className="flex pt-4 px-10 w-4/5">
